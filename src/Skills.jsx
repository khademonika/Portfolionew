...
function Skills() {
  return (
    ...
    // </div>
    <div>
      <h1 className='text-5xl my-9 font-bold underline  text-white '>Skills set</h1>
   <div className='grid grid-cols-3 gap-7'>
       <SkillComp Name = "Github" des="I use GitHub for version control, collaboration, 
       and project management. I'm comfortable with branching, pull requests, and maintaining a clean commit history." icon={<BsGithub/>}/>
      <SkillComp Name = "HTmL" des="I have a strong command of HTML for building clean, well-structured,
       and accessible web pages. I follow semantic markup practices to ensure better SEO and maintainability." icon={<DiHtml5/>}/>
      <SkillComp Name = "React" des="I create dynamic and interactive user interfaces using React. I understand component-based architecture, props,
       state management, and React hooks for building responsive single-page applications." icon={<FaReact/>}/>
      <SkillComp Name = "Python" des="I use Python for scripting, data analysis, and backend logic development.
       I’m familiar with libraries like Pandas and have built small projects to automate tasks and process data." icon={<FaPython/>}/>
      <SkillComp Name = "Nextjs" des="I build modern, full-stack web applications using Next.js with features like routing, server-side rendering, 
      and API integration. I'm comfortable using Next.js with Tailwind CSS and Prisma for scalable apps." icon={<RiNextjsFill/>}/>
   </div>
